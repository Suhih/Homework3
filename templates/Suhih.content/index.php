...
<!--		<link rel="stylesheet" href="--><?php //echo $this->baseurl ?><!--/templates/--><?php //echo $this->template; ?><!--/css/beez5.css" type="text/css" />-->
        <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/Suhih.content/css/style.css" type="text/css" />
<?php
...
<!--			var rightopen='--><?php //echo JText::_('', true); ?><!--';-->
<!--			var rightclose='--><?php //echo JText::_('', true); ?><!--';-->
...
<!--					<img src="--><?php //echo $this->baseurl ?><!--/--><?php //echo htmlspecialchars($logo); ?><!--" alt="--><?php //echo htmlspecialchars($templateparams->get('sitetitle'));?><!--" />-->
					...
					<ul class="skiplinks">
						<li><a href="#main" class="u2"><?php echo JText::_(''); ?></a></li>
						<li><a href="#nav" class="u2"><?php echo JText::_(''); ?></a></li>
						<?php if($showRightColumn ):?>
						<li><a href="#additional" class="u2"><?php echo JText::_(''); ?></a></li>
						<?php endif; ?>
					</ul>
					<h2 class="unseen"><?php echo JText::_(''); ?></h2>
...
<!--				<img src="--><?php //echo $this->baseurl ?><!--/templates/--><?php //echo $this->template; ?><!--/images/fruits.jpg"  alt="--><?php //echo JText::_('TPL_BEEZ5_LOGO'); ?><!--" />-->
		...
		<?php endif ; ?>
			...
			<?php endif; ?>
					...
					<p>
						<?php echo JText::_('');?> <a href="http://www.joomla.org/">Joomla!&#174;</a>
					</p>
